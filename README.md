...
### Submitting an Issue
If you find a bug or a mistake, you can help by submitting an issue to [GitLab Repository](https://github.com/Deepta-Das/pdf-parser)
...
## License
[MIT licensed](https://github.com/Deepta-Das/pdf-parser/blob/main/LICENSE) and all it's dependencies are MIT or BSD licensed.
